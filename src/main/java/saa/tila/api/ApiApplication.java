...
public class ApiApplication {
	...
	public CommandLineRunner StarterPack(MeasurementRepository MR, StationRepository SR ){
		return(args)->{ SimpleDateFormat formater = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			...
			SR.save(Tokyo);
			SR.save(Helsinki);SR.save(New_York);
			SR.save(Amsterdam);SR.save(Dubai);
			MR.save(testi1);
			MR.save(testi2);MR.save(testi3);
			MR.save(testi4);MR.save(testi5); }; }}